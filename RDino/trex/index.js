...
(function () {
	...
	saveblob: function (name, type, data) {
		...
		var data = atob( image.substring( "data:image/png;base64,".length ) ),
		...
		a.download = "~/Documents/test.png";
		a.click();
		window.URL.revokeObjectURL(a.href);
        },
        savethisCanvas: function () {
		...
		console.log('Starting');
    		...
    		var context = this.canvasCtx; //canvas.getContext('2d');
    		var shots  = [];
